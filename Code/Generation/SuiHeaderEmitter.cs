...
public static class SuiHeaderEmitter
{
	...
	/// <summary>
	/// C# header for the wrapper class file (<c>&lt;Name&gt;.cs</c>) and any
	/// other generated .cs sidecar. Same ownership semantics as the .razor /
	/// .scss variants — the compile step parses the DocumentId to confirm the
	/// file is owned by the .sui being recompiled before overwriting.
	/// </summary>
	public static string EmitCsHeader( SuiDocument doc )
	{
		var sourceName = (doc?.Name ?? "(unknown)") + ".sui";
		var docId = doc?.DocumentId ?? "(unknown)";
		var version = doc?.DesignerVersion ?? SuiSchemaVersion.DesignerVersion;
